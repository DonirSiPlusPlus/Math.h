...
START_TEST(s21_fmod_test) {
    ...
    ck_assert_double_eq_tol(s21_fmod(-3.33, s21_INF), fmod(-3.33, s21_INF),
                            1e-6);
    ...
    ck_assert_double_eq_tol(s21_fmod(-100000.21, -0.21),
                            fmod(-100000.21, -0.21), 1e-6);
...
START_TEST(s21_sin_test) {
    ...
    ck_assert_double_eq_tol(sin(3.0 * s21_PI / 2.0),
                            s21_sin(3.0 * s21_PI / 2.0), 1e-6);
...
START_TEST(test_s21_pow) {
    ...
    ck_assert_ldouble_eq_tol(s21_pow(-s21_INF, -s21_INF),
                             pow(-s21_INF, -s21_INF), 1e-6);
